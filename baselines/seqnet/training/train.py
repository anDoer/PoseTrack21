...
from default_configs.defaults import get_default_cfg
...
def main(args):
    ...
    print("Loading data")
    if not args.eval:
        train_loader = build_train_loader(cfg, mask_images=args.with_ignore_regions)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--with_ignore_regions', action='store_true')
