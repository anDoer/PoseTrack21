...
_C.AUGMENTATION = CN() 
_C.AUGMENTATION.COLOR_JITTER = False
# -------------------------------------------------------- #
#                          Solver                          #
# -------------------------------------------------------- #
_C.SOLVER = CN()
...
#                    Keypoint head                         #
# -------------------------------------------------------- #
_C.MODEL.ROI_HEAD.KEYPOINT_HEAD = CN()
_C.MODEL.ROI_HEAD.KEYPOINT_HEAD.ACTIVE = False
_C.MODEL.ROI_HEAD.KEYPOINT_HEAD.TYPE = 'standard'
_C.MODEL.ROI_HEAD.KEYPOINT_HEAD.LAYERS = 8
_C.MODEL.ROI_HEAD.KEYPOINT_HEAD.NUM_KEYPOINTS = 15
_C.MODEL.ROI_HEAD.KEYPOINT_HEAD.PREDICTOR_TYPE = 'standard'
